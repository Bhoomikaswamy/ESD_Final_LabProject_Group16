...
// Define GPIO pin macros for your chip select and reset pins

//#define GPIO_PIN_1  0x02  // Pin 1 of Port F (used for reset)
//#define GPIO_PIN_2 0x04  // Pin 2 of Port A (SPI clock)
//#define GPIO_PIN_3 0x08  // Pin 3 of Port A (chip select)
//#define GPIO_PIN_4 0x10  // Pin 4 of Port A (SPI MISO)
//#define GPIO_PIN_5 0x20  // Pin 5 of Port A (SPI MOSI)
//#define GPIO_PIN_1 0x02  // Pin 1 of Port F (reset)
